        ...
        <div className="container">
            ...
            <div className="row  d-flex justify-content-center">
                <div className="col-sm-6">
                    <input   id="searchinput" placeholder="Nhập từ khóa" type="text" class="form-control" onChange={handleSearch} />
                 </div>
            </div>
            <br></br>
            ...
            {a && a.map((item)=>(
                ...
                <div className="content">
                    ...
                    <svg data-testid="icon-svg" className="IconStyle" width="1em" 
