        ...
        <div className="container">
            ...
            {show && show.map((item)=>(
                ...
                <div className="content">
                    ...
                    <div className="item">
                        <div>
                        <svg data-testid="icon-svg" className="IconStyle" width="1em" height="1em" fill="currentColor" viewBox="0 0 100 100"><path d="M100,0 L100,100 L73.9128906,100 
                    ...
                    <div className="item">
                        <div>
                        <svg data-testid="icon-svg" className="IconStyle" width="1em" height="1em" fill="currentColor" viewBox="0 0 100 100"><path d="M37.4726562,59.9636719 L37.4726562,68.8853516 C37.4726562,69.8521484 37.8257812,70.6894531 
                    ...
                    <div className="item">
                        <div>
                        <svg xmlns="http://www.w3.org/2000/svg" className="IconStyle" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
