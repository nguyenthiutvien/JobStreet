...
import { addJob, updateJob, deleteJob, getApplicationsCompany, getTokenCompany, getJobsCompany, updateCompanyInfo, companyChangePassword } from '../../api/Api';
      ...
      <div className="container--user--profile">
        <div className="user--profile--left">
          <TabBar
            ...
            handelJob={handelJob}
            changePassword={handelCompanyChangePassword}
